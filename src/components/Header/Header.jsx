...
export const Header = () => {
	...
	return (
		<>
					...
					<div className='mycontainer top_container'>
						<div className='top_shopping'>
							<p className='flex items-center gap-[15px] flex-wrap'>
								...
								Xizmatlarimiz haqida bepul ma’lumot olish uchun qo'ng'iroq
								qiling!
							</p>
			...
			{isOffcanvasOpen && (
				<nav className='navbar_offcanvas bg-[#EDF2F7]  dark:bg-[#475569]  w-[70vw] z-50 fixed top-0 left-0  h-screen  '>
...
<img src={logo} alt="logo" className='  w-[130px]' />
					...
					<div className=' bg-[#EDF2F7]  dark:bg-[#475569] h-screen  px-2 '>
						<div className='navbar_box  mt-0'>

						<Link
									to={'/'}
									className=' my-[15px] w-full   rounded-[12px] flex items-center justify-center md:py-[16px] md:px-[24px] px-[16px] py-[10px] bg-[tranparent]  hover:bg-[#0FC36D] border-[1px] border-[#0FC36D]  text-[#0FC36D] hover:text-white shadow-lg font-bold md:text-[16px] text-[14px] transition'
								>
									Home
								</Link>
